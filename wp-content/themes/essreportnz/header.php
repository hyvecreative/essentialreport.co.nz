...
<div id="header" class="header lo-shadow">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
			<div class="navbar-toggler menu-btn" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-controls="bs-example-navbar-collapse-1" aria-expanded="false" aria-label="<?php esc_attr_e( 'Toggle navigation', 'navdev' ); ?>">
