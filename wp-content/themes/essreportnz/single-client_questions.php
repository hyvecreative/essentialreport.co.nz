	...
	<div class="col-sm-12 col-md-8 offset-md-2 single-question">		
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>	
					...
					<div class="postItem itemContent">
						...
						<div class="purchesed-hd text-center" style="color: #fff; font-size: 1.4rem; background: #262c30; padding: .5rem; margin-top: 1rem;">Purchased question results</div>
						...
						<div class="cat-wrap">
							...
							<?php           
							$product_terms = wp_get_object_terms( $post->ID,  'client_categories' );
									if ( ! empty( $product_terms ) ) {
									if ( ! is_wp_error( $product_terms ) ) {
									foreach( $product_terms as $term ) {
									echo '<a class="' . $term->slug .'" href="' . get_term_link( $term->slug, 'client_categories' ) . '">' . esc_html( $term->name ) . '</a> '; 
									}
						...
						<h1 style="margin-top: .5rem;"><?php the_title(); ?></h1>
